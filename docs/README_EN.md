...
> save combinations you like as Profiles. Free, bilingual (中文 / English).

[**Download**](https://aimloom.dev/en/download/) · [**Features**](#features) · [**Requirements**](#requirements) · [**Develop**](#develop) · [**Roadmap**](../ROADMAP.md)
